...
export const products = {
  ...
  "product-5": {
    ...
    description: "Indulge in luxury with the Glowic 24K Gold Face Mask. Infused with real gold particles, this mask brightens, firms, and revitalizes your skin for a radiant, youthful glow.",
    longDescription: "Our lightweight sunscreen provides broad spectrum SPF 50 protection while being gentle on your skin. Perfect for daily use under makeup.",
    price: 34.99,
    comparePrice: 44.99,
    type: "sunscreen",
